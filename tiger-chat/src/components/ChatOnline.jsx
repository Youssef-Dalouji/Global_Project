...
const ChatOnline=() => {
    ...
    const queryExistRoom=useQuery('findRooms',()=>{
        return axios.post('http://3.141.21.101:5500/room/query',{idRoom:iRdecr},{headers:{Authorization:`Bearer ${window.sessionStorage.getItem('idUserSerie')}`}})
    },{
        refetchInterval:1000,
        refetchIntervalInBackground:true
    })
    const queryInformationsRoom=useQuery('GETInformationsRoom',()=>{
        return axios.post('http://3.141.21.101:5500/room/queryInformationsRoom',{idRoom:iRdecr},{headers:{Authorization:`Bearer ${window.sessionStorage.getItem('idUserSerie')}`}})
    },{
        refetchInterval:1000,
        refetchIntervalInBackground:true
    })
    const queryExistUserInRoom=useQuery('ExistUserInRoom',() => {
        return axios.post('http://3.141.21.101:5500/room/ConnectRoom',{idRoom:iRdecr},{headers:{Authorization:`Bearer ${window.sessionStorage.getItem('idUserSerie')}`}})
    },{
        refetchInterval:1000,
        refetchIntervalInBackground:true
    })
    const queryPingUser=useQuery('ExistUserOnLine',() => {
        return axios.post('http://3.141.21.101:5500/M-1351919175/queryPingConnect',{idRoom:iRdecr},{headers:{Authorization:`Bearer ${window.sessionStorage.getItem('idUserSerie')}`}})
    },{
        refetchInterval:1000,
        refetchIntervalInBackground:true
    })
    const getDataUserChat=useQuery('DataUserChat',() => {
        return axios.post('http://3.141.21.101:5500/M-1351919175/get',{idRoom:iRdecr},{headers:{Authorization:`Bearer ${window.sessionStorage.getItem('idUserSerie')}`}})
    },{
        refetchInterval:1000,
        refetchIntervalInBackground:true
    })
    const envMessage=() => {
      if(message!==''){
        ...
        const SendMsg=async ()=>{
            let resu=await axios.post('http://3.141.21.101:5500/M-1351919175/create',{message:message,idRoom:iRdecr,name:ndecr},{headers:{Authorization:`Bearer ${window.sessionStorage.getItem('idUserSerie')}`}})
